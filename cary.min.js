...
Cary.Map.prototype.insertIcon = function (name, lat, lon, options)
{
    var props = {};
    var icon;
    ...
    icon = new Cary.userObjects.UserIcon (name, { lat: lat, lon: lon }, props);
...
Cary.tools.saveFile = function (content, fileName)
{
    var link = document.createElement ('a');
    
    link.href = "data:'text/plain;' charset=utf-8," + escape (content);
...
Cary.maps.overlayMaps.CustomOverlayMapType = function (name, getTileUrl, layer)
{
...
Cary.controls.Tag = function (map, position, text, minZoom, styles, zoomToFontSize)
{
    var options = {};
...
Cary.controls.Tag.prototype.checkZoomWatchdog = function ()
{
    ...
    function onZoomChanged ()
    {
        ...
        if (visible && instance.zoomToFontSize !== null)
...
Cary.ui.Control.prototype.show = function (visible)
{
    ...
    {
        if (visible && !this.parent.contains (this.htmlObject))
...
Cary.ui.ListView.prototype.insertItem = function (columnText, data, index)
{
    ...
    {
        var headerHeight = this.header.offsetHeight ? this.header.offsetHeight : 25;
...
Cary.ui.UserPolygonPropsWnd.prototype.onInitialize = function ()
{
    ...
    var fillColorBlock  = new Cary.ui.ControlBlock ({ parent: this.client, visible: true, text: stringTable.fillColor }, this.ctlBlkStyle);
